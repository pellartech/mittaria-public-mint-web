export const GENESIS_MINT_ABI = [
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'uint16', name: 'maxPerTxn', type: 'uint16' },
        ...
        indexed: false,
        internalType: 'struct MittariaGenesisDev.Configs',
        name: 'configs',
        type: 'tuple'
      }
    ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_phaseId', type: 'uint256' }],
    name: 'getPhaseInfo',
    outputs: [
      {
        components: [
      ...
      { internalType: 'uint16', name: 'totalMinted', type: 'uint16' }
    ],
    stateMutability: 'view',
    type: 'function'
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint16', name: '_maxAmount', type: 'uint16' },
  ...
  {
    inputs: [{ internalType: 'uint16', name: '_maxSupply', type: 'uint16' }],
    name: 'setTotalSupply',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function'
